...
- Updated to [Android SDK v3000.0.0](https://github.com/blinkcard/blinkcard-android/releases/tag/v3000.0.0) and [iOS SDK v3000.0.0](https://github.com/BlinkCard/blinkcard-ios/releases/tag/v3000.0.0)
...
- See the [SDK loading & unloading](https://github.com/blinkcard/blinkcard-flutter?tab=readme-ov-file#sdk-loading--unloading) section in README.md for more information.
...
- All of the available results can be viewed [here](https://github.com/BlinkCard/blinkcard-flutter/blob/main/BlinkCard/lib/blinkcard_result.dart).

**Implementation guide**
- A detailed guide about the integration and usage of the plugin can be viewed [here](https://github.com/BlinkCard/blinkcard-flutter/tree/main?tab=readme-ov-file#plugin-integration).
- The sample application which demonstrates the usage of the SDK can be found in the [main.dart](https://github.com/BlinkCard/blinkcard-flutter/blob/main/sample_files/main.dart) file.
